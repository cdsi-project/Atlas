...
- 主窗口进度区固定在选项卡内容下方、状态栏上方，扫描时持续显示阶段、进度条和当前处理路径
...
- “统计”页签集中展示视频、音频、图片、文本/文档及其他类型数量，可用本地文件、不可用资产、已备份与未备份资产、备份覆盖率、占用空间和视频总时长
...
- “工具”：打开任务中心或设置
- “帮助”：打开随应用发布的 README、数据安全说明、Apache 2.0 协议、第三方许可和关于窗口
...
“统计”页签展示整个本地资产索引的汇总，不受资产列表当前搜索条件或分页影响。已从资产列表隐藏的资产不计入统计。
